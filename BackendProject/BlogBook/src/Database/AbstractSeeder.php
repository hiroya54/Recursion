...
abstract class AbstractSeeder implements Seeder {
    ...
    protected function insertRow(array $row): void {
        ...
        $dataTypes = array_map(function($columnInfo){ return static::AVAILABLE_TYPES[$columnInfo['data_type']];}, $this->tableColumns);
        ...
        $stmt->bind_param(implode('', $dataTypes), ...array_values($row));
